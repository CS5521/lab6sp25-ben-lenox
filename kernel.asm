...
80102b25:	81 7d 08 48 65 11 80 	cmpl   $0x80116548,0x8(%ebp)
...
80103784:	80 
80103785:	c7 04 24 48 65 11 80 	movl   $0x80116548,(%esp)
...
801041f5:	81 7d f4 f4 5c 11 80 	cmpl   $0x80115cf4,-0xc(%ebp)
801041fc:	72 a7                	jb     801041a5 <allocproc+0x1b>
  release(&ptable.lock);
801041fe:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
8010429a:	a3 40 b6 10 80       	mov    %eax,0x8010b640
...
8010439a:	89 42 68             	mov    %eax,0x68(%edx)
  ...
  acquire(&ptable.lock);
8010439d:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
801043ac:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  ...
  release(&ptable.lock);
801043b3:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80104596:	89 45 d8             	mov    %eax,-0x28(%ebp)
  ...
  acquire(&ptable.lock);
80104599:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
801045a8:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  ...
  release(&ptable.lock);
801045af:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
801045d1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  if(curproc == initproc)
801045d4:	a1 40 b6 10 80       	mov    0x8010b640,%eax
...
8010466b:	e8 cc 03 00 00       	call   80104a3c <wakeup1>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104670:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
...
80104682:	75 24                	jne    801046a8 <exit+0xe2>
      p->parent = initproc;
80104684:	8b 15 40 b6 10 80    	mov    0x8010b640,%edx
...
801046db:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  acquire(&ptable.lock);
801046de:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
801046ea:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046f1:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
...
80104776:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        release(&ptable.lock);
8010477d:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80104792:	81 7d f4 f4 5c 11 80 	cmpl   $0x80115cf4,-0xc(%ebp)
...
801047ad:	74 13                	je     801047c2 <wait+0xf2>
      release(&ptable.lock);
801047af:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
801047c2:	c7 44 24 04 c0 3d 11 	movl   $0x80113dc0,0x4(%esp)
801047c9:	80 
...
801047f7:	e8 ac f8 ff ff       	call   801040a8 <sti>
    ...
    acquire(&ptable.lock);
801047fc:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104803:	e8 90 05 00 00       	call   80104d98 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104808:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
...
8010486d:	81 7d f4 f4 5c 11 80 	cmpl   $0x80115cf4,-0xc(%ebp)
...
80104895:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
8010493c:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80104954:	e8 2e ff ff ff       	call   80104887 <sched>
  release(&ptable.lock);
80104959:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
8010496a:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
8010496d:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
801049d8:	81 7d 0c c0 3d 11 80 	cmpl   $0x80113dc0,0xc(%ebp)
801049df:	74 17                	je     801049f8 <sleep+0x52>
    acquire(&ptable.lock);  //DOC: sleeplock1
801049e1:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80104a1a:	81 7d 0c c0 3d 11 80 	cmpl   $0x80113dc0,0xc(%ebp)
80104a21:	74 17                	je     80104a3a <sleep+0x94>
    release(&ptable.lock);
80104a23:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80104a3f:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104a42:	c7 45 fc f4 3d 11 80 	movl   $0x80113df4,-0x4(%ebp)
...
80104a6f:	81 7d fc f4 5c 11 80 	cmpl   $0x80115cf4,-0x4(%ebp)
...
80104a7d:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104a80:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80104a92:	e8 a5 ff ff ff       	call   80104a3c <wakeup1>
  release(&ptable.lock);
80104a97:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80104aa8:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104aab:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80104ab2:	e8 e1 02 00 00       	call   80104d98 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104ab7:	c7 45 f4 f4 3d 11 80 	movl   $0x80113df4,-0xc(%ebp)
...
80104ae3:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104aea:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80104b01:	81 7d f4 f4 5c 11 80 	cmpl   $0x80115cf4,-0xc(%ebp)
80104b08:	72 b6                	jb     80104ac0 <kill+0x1b>
    }
  }
  release(&ptable.lock);
80104b0a:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80104b20:	83 ec 58             	sub    $0x58,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b23:	c7 45 f0 f4 3d 11 80 	movl   $0x80113df4,-0x10(%ebp)
...
80104c05:	81 7d f0 f4 5c 11 80 	cmpl   $0x80115cf4,-0x10(%ebp)
...
80105445:	83 f8 18             	cmp    $0x18,%eax
...
80106224:	83 ec 08             	sub    $0x8,%esp
  fk_count++;
80106227:	a1 44 b6 10 80       	mov    0x8010b644,%eax
8010622c:	83 c0 01             	add    $0x1,%eax
8010622f:	a3 44 b6 10 80       	mov    %eax,0x8010b644
  return fork();
...
80106306:	eb 6b                	jmp    80106373 <sys_sleep+0x8f>
  acquire(&tickslock);
80106308:	c7 04 24 00 5d 11 80 	movl   $0x80115d00,(%esp)
8010630f:	e8 84 ea ff ff       	call   80104d98 <acquire>
  ticks0 = ticks;
80106314:	a1 40 65 11 80       	mov    0x80116540,%eax
...
80106328:	74 13                	je     8010633d <sys_sleep+0x59>
      release(&tickslock);
8010632a:	c7 04 24 00 5d 11 80 	movl   $0x80115d00,(%esp)
...
8010633d:	c7 44 24 04 00 5d 11 	movl   $0x80115d00,0x4(%esp)
80106344:	80 
80106345:	c7 04 24 40 65 11 80 	movl   $0x80116540,(%esp)
8010634c:	e8 55 e6 ff ff       	call   801049a6 <sleep>
  while(ticks - ticks0 < n){
80106351:	a1 40 65 11 80       	mov    0x80116540,%eax
...
80106360:	72 bc                	jb     8010631e <sys_sleep+0x3a>
  ...
  release(&tickslock);
80106362:	c7 04 24 00 5d 11 80 	movl   $0x80115d00,(%esp)
...
80106378:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
8010637b:	c7 04 24 00 5d 11 80 	movl   $0x80115d00,(%esp)
80106382:	e8 11 ea ff ff       	call   80104d98 <acquire>
  xticks = ticks;
80106387:	a1 40 65 11 80       	mov    0x80116540,%eax
8010638c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
8010638f:	c7 04 24 00 5d 11 80 	movl   $0x80115d00,(%esp)
...
801063a3:	83 ec 18             	sub    $0x18,%esp
  cprintf("hello world!\n");
801063a6:	c7 04 24 37 87 10 80 	movl   $0x80108737,(%esp)
...
// returns the number of forks that have been created
int
sys_fkc(void)
{
...
801063bc:	83 ec 28             	sub    $0x28,%esp
  int arg;
  if (argint(0, &arg) < 0) return fk_count;
...
801063d6:	a1 44 b6 10 80       	mov    0x8010b644,%eax
801063db:	eb 16                	jmp    801063f3 <sys_fkc+0x3a>
  if (arg == 0){
801063dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063e0:	85 c0                	test   %eax,%eax
801063e2:	75 0a                	jne    801063ee <sys_fkc+0x35>
    fk_count = 0;
801063e4:	c7 05 44 b6 10 80 00 	movl   $0x0,0x8010b644
801063eb:	00 00 00 
  }
  return fk_count;
801063ee:	a1 44 b6 10 80       	mov    0x8010b644,%eax
}
801063f3:	c9                   	leave  
801063f4:	c3                   	ret    
...
80106467:	8b 04 85 84 b0 10 80 	mov    -0x7fef4f7c(,%eax,4),%eax
8010646e:	89 c2                	mov    %eax,%edx
80106470:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106473:	66 89 14 c5 40 5d 11 	mov    %dx,-0x7feea2c0(,%eax,8)
8010647a:	80 
8010647b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010647e:	66 c7 04 c5 42 5d 11 	movw   $0x8,-0x7feea2be(,%eax,8)
80106485:	80 08 00 
80106488:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010648b:	0f b6 14 c5 44 5d 11 	movzbl -0x7feea2bc(,%eax,8),%edx
80106492:	80 
80106493:	83 e2 e0             	and    $0xffffffe0,%edx
80106496:	88 14 c5 44 5d 11 80 	mov    %dl,-0x7feea2bc(,%eax,8)
8010649d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064a0:	0f b6 14 c5 44 5d 11 	movzbl -0x7feea2bc(,%eax,8),%edx
801064a7:	80 
801064a8:	83 e2 1f             	and    $0x1f,%edx
801064ab:	88 14 c5 44 5d 11 80 	mov    %dl,-0x7feea2bc(,%eax,8)
801064b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064b5:	0f b6 14 c5 45 5d 11 	movzbl -0x7feea2bb(,%eax,8),%edx
801064bc:	80 
801064bd:	83 e2 f0             	and    $0xfffffff0,%edx
801064c0:	83 ca 0e             	or     $0xe,%edx
801064c3:	88 14 c5 45 5d 11 80 	mov    %dl,-0x7feea2bb(,%eax,8)
801064ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064cd:	0f b6 14 c5 45 5d 11 	movzbl -0x7feea2bb(,%eax,8),%edx
801064d4:	80 
801064d5:	83 e2 ef             	and    $0xffffffef,%edx
801064d8:	88 14 c5 45 5d 11 80 	mov    %dl,-0x7feea2bb(,%eax,8)
801064df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064e2:	0f b6 14 c5 45 5d 11 	movzbl -0x7feea2bb(,%eax,8),%edx
801064e9:	80 
801064ea:	83 e2 9f             	and    $0xffffff9f,%edx
801064ed:	88 14 c5 45 5d 11 80 	mov    %dl,-0x7feea2bb(,%eax,8)
801064f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064f7:	0f b6 14 c5 45 5d 11 	movzbl -0x7feea2bb(,%eax,8),%edx
801064fe:	80 
801064ff:	83 ca 80             	or     $0xffffff80,%edx
80106502:	88 14 c5 45 5d 11 80 	mov    %dl,-0x7feea2bb(,%eax,8)
80106509:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010650c:	8b 04 85 84 b0 10 80 	mov    -0x7fef4f7c(,%eax,4),%eax
80106513:	c1 e8 10             	shr    $0x10,%eax
80106516:	89 c2                	mov    %eax,%edx
80106518:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010651b:	66 89 14 c5 46 5d 11 	mov    %dx,-0x7feea2ba(,%eax,8)
80106522:	80 
  for(i = 0; i < 256; i++)
...
80106534:	a1 84 b1 10 80       	mov    0x8010b184,%eax
80106539:	66 a3 40 5f 11 80    	mov    %ax,0x80115f40
8010653f:	66 c7 05 42 5f 11 80 	movw   $0x8,0x80115f42
80106546:	08 00 
80106548:	0f b6 05 44 5f 11 80 	movzbl 0x80115f44,%eax
8010654f:	83 e0 e0             	and    $0xffffffe0,%eax
80106552:	a2 44 5f 11 80       	mov    %al,0x80115f44
80106557:	0f b6 05 44 5f 11 80 	movzbl 0x80115f44,%eax
8010655e:	83 e0 1f             	and    $0x1f,%eax
80106561:	a2 44 5f 11 80       	mov    %al,0x80115f44
80106566:	0f b6 05 45 5f 11 80 	movzbl 0x80115f45,%eax
8010656d:	83 c8 0f             	or     $0xf,%eax
80106570:	a2 45 5f 11 80       	mov    %al,0x80115f45
80106575:	0f b6 05 45 5f 11 80 	movzbl 0x80115f45,%eax
8010657c:	83 e0 ef             	and    $0xffffffef,%eax
8010657f:	a2 45 5f 11 80       	mov    %al,0x80115f45
80106584:	0f b6 05 45 5f 11 80 	movzbl 0x80115f45,%eax
8010658b:	83 c8 60             	or     $0x60,%eax
8010658e:	a2 45 5f 11 80       	mov    %al,0x80115f45
80106593:	0f b6 05 45 5f 11 80 	movzbl 0x80115f45,%eax
8010659a:	83 c8 80             	or     $0xffffff80,%eax
8010659d:	a2 45 5f 11 80       	mov    %al,0x80115f45
801065a2:	a1 84 b1 10 80       	mov    0x8010b184,%eax
801065a7:	c1 e8 10             	shr    $0x10,%eax
801065aa:	66 a3 46 5f 11 80    	mov    %ax,0x80115f46

  initlock(&tickslock, "time");
801065b0:	c7 44 24 04 48 87 10 	movl   $0x80108748,0x4(%esp)
801065b7:	80 
801065b8:	c7 04 24 00 5d 11 80 	movl   $0x80115d00,(%esp)
...
801065d3:	00 
801065d4:	c7 04 24 40 5d 11 80 	movl   $0x80115d40,(%esp)
...
80106654:	75 31                	jne    80106687 <trap+0xa5>
      acquire(&tickslock);
80106656:	c7 04 24 00 5d 11 80 	movl   $0x80115d00,(%esp)
8010665d:	e8 36 e7 ff ff       	call   80104d98 <acquire>
      ticks++;
80106662:	a1 40 65 11 80       	mov    0x80116540,%eax
80106667:	83 c0 01             	add    $0x1,%eax
8010666a:	a3 40 65 11 80       	mov    %eax,0x80116540
      wakeup(&ticks);
8010666f:	c7 04 24 40 65 11 80 	movl   $0x80116540,(%esp)
80106676:	e8 ff e3 ff ff       	call   80104a7a <wakeup>
      release(&tickslock);
8010667b:	c7 04 24 00 5d 11 80 	movl   $0x80115d00,(%esp)
...
8010692b:	eb 5e                	jmp    8010698b <uartinit+0x102>
  uart = 1;
8010692d:	c7 05 48 b6 10 80 01 	movl   $0x1,0x8010b648
80106934:	00 00 00 
...
80106990:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106993:	a1 48 b6 10 80       	mov    0x8010b648,%eax
...
801069ee:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
801069f1:	a1 48 b6 10 80       	mov    0x8010b648,%eax
...
80107510:	05 20 38 11 80       	add    $0x80113820,%eax
...
801079c4:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
...
80107a21:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
...
80107a3e:	a3 44 65 11 80       	mov    %eax,0x80116544
  switchkvm();
...
80107a50:	a1 44 65 11 80       	mov    0x80116544,%eax
